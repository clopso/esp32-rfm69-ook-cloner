...
#define CONFIG_OOK (RH_RF69_DATAMODUL_DATAMODE_CONT_WITH_SYNC | RH_RF69_DATAMODUL_MODULATIONTYPE_OOK | RH_RF69_DATAMODUL_MODULATIONSHAPING_OOK_NONE)
...
void setRxContinuousMode()
{
	...
	spiWrite(RH_RF69_REG_02_DATAMODUL, RH_RF69_DATAMODUL_DATAMODE_CONT_WITH_SYNC | RH_RF69_DATAMODUL_MODULATIONTYPE_OOK);
	spiWrite(RH_RF69_REG_01_OPMODE, RH_RF69_OPMODE_SEQUENCEROFF | RH_RF69_OPMODE_MODE_RX);

	spiWrite(RH_RF69_DIOMAPPING1_DIO1MAPPING, RH_RF69_DIOMAPPING1_DIO1MAPPING_00); // Set interrupt line 0 PayloadReady
