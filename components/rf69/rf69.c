...
#define CONFIG_OOK (RH_RF69_DATAMODUL_DATAMODE_CONT_WITHOUT_SYNC | RH_RF69_DATAMODUL_MODULATIONTYPE_OOK | RH_RF69_DATAMODUL_MODULATIONSHAPING_OOK_NONE)
...
void setRxContinuousMode()
{
	...
	spiWrite(RH_RF69_REG_01_OPMODE, (1 << 7) | (4 << 2));

	while (!(readIRQflag() & (1 << 7)))
		;
}
